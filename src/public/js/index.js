        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            async function carregarTreino() {
                ...
                const exercisesToFetch = []; // Guarda [{id: 't01', day: 'a'}, {id: 't03', day: 'b'}]
                const idList = []; // Guarda ['t01', 't03']
                ...
                if (idList.length === 0) {
                    displayArea.innerHTML = '<p>Nenhum exercício válido encontrado na string.</p>';
                    return;
                }
                ...
                try {
                    ...
                    const exercisesInfo = await response.json(); // Array com infos do banco
